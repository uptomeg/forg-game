...
sub $t9, $t9, $t1			# Move $a0 back to the first column
...
sw $a2, 0($t9)	
addi $a0, $a0, 4
addi $t9, $t9, 4		# Move current pixel position one pixel to the right
