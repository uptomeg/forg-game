...
sw $t9, vidasNum
	...
	#Loop donde reiniciar� la posicion de la rana
	recargarMapa:
...
# ------------ ALGORITMO PARA MOVER A LA RANA -------------
	...
	moverRana:
	add $t1, $t1, $s7 #Se a�ade a $t1 adonde se quiere mover ($s7 tenia la posicion actual, pero fue modificada en las funciones de arriba)
